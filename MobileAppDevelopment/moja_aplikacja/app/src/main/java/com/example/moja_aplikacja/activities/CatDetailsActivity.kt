...
import com.example.moja_aplikacja.views.CatDetails
            ...
            Moja_aplikacjaTheme {
                ...
                val models = listOf(
                    MenuModel(Icons.Default.Home, "Home") {
                        scope.launch {
                            drawerState.close()
                            val intent = Intent(this@CatDetailsActivity, HomeActivity::class.java)
                    ...
                    MenuModel(Icons.Default.ShoppingCart, "Buy cats") {
                        scope.launch {
                            drawerState.close()
                            val intent = Intent(this@CatDetailsActivity, BuyCatsActivity::class.java)
                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT)
                            startActivity(intent)
                        }
                    },
                    ...
                    MenuModel(Icons.Default.Person, "Profile")  {
                        scope.launch {
                            drawerState.close()
                            val intent = Intent(this@CatDetailsActivity, ProfileActivity::class.java)
                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT)
                            startActivity(intent)
                        }
                    }
