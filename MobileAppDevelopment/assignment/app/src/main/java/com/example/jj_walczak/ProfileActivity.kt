    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Jj_walczakTheme() {
                ...
                val models = listOf(
                    MenuModel(Icons.Default.Search, "Profile") {
                        scope.launch {
                            drawerState.close()
                    ...
                    /*
                    MenuModel(Icons.Default.Profile, "Search") {
                        scope.launch {
                            drawerState.close()
                            val intent = Intent(this@com.example.jj_walczak.HomeActivity, ProfileActivity::class.java)
                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT)
                            startActivity(intent)
                        }
                    },
